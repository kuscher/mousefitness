(function() {
  ...
  try {
    ...
    if (DEBUG) console.warn("Mouse Fitness: Extension context may be invalidated.", e);
  }
  ...
  function flushDistance() {
    if (accumulatedPixels > 0) {
      ...
      try {
        ...
        if (DEBUG) console.warn("Mouse Fitness: Failed to send message (extension likely reloaded).", err);
      }
    }
  }
